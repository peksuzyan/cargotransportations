...
<c:set var="innerDivClass" value="col-xs-push-3 col-xs-6" />
<c:set var="buttonDivClass" value="col-xs-12" />
<c:set var="labelClass" value="control-label" />
<c:set var="headerClass" value="col-xs-push-3 col-xs-3" />
...
<spring:url var="checkURL" value="/trucks/${truck.id}?check"  />
<spring:url var="deleteURL" value="/trucks/${truck.id}?delete" />
<spring:url var="cancelURL" value="/trucks" />
...
<c:if test="${truck.id != 0}">
    <div class="${outerDivClass}">
        <div class="${innerDivClass}">
            ...
            <form:errors path="${id}" cssClass="${errorsClass}" />
        </div>
    </div>
</c:if>
